...
export default function HomeScreen() {
    ...
    const handleNewChatPress = () => {
        ...
        // You would add navigation to your New Chat screen here
    };

    const handleNewRecipePress = () => {
        console.log('Navigate to New Recipe Screen');
        // You would add navigation to your New Recipe screen here
    };
        ...
        <TouchableOpacity style={styles.recentCard}>
            ...
            <View style={styles.recentInfo}>
                ...
                <View style={styles.recentStats}>
                    <Text style={styles.recentTime}>{item.duration}</Text>
        ...
        <SafeAreaView style={styles.container}>
            ...
            <View style={styles.bottomNav}>
                <TouchableOpacity style={styles.navItem}>
                    <Ionicons name="home" size={24} color="#FE724C" />
